from . import app
from health_and_fitness_api.routes import user_signup, user_verify, user_login, get_diet_plans, calculate_cal
...
app.add_url_rule('/calculate_cal', methods=['POST'], view_func=calculate_cal)